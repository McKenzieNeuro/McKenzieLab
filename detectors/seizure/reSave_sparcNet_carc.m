function reSave_sparcNet_carc(idx)

idx = (idx-1)*100+1:(idx-1)*100+100;
v=load('/carc/scratch/projects/bshuttleworth2016391/mckenzie2016183/data/HarvardEEGDatabase/bids/matfils.mat');
...
for i = idx
    ...
    if ~exist(outfil)
        tmp  = readtable(featue_file);
        Y=cell2mat(table2cell(tmp));
        load(fil)
