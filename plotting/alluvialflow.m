...
%    parameters etc.
    ...
    text(zeros(1, size(data, 1)) - 0.01, ...
         ...
         left_labels, 'FontSize', 12, 'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'Rotation', 0);
     
    % Place right labels
    text(ones(1, size(data, 2)) + 0.01, ...
         right_category_points + right_category_sizes./2, ...
         right_labels, 'FontSize', 12, 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'Rotation', 0);
