...
StartTime = [8,30]; % Time to begin recording in 24hr time, format = [hr,min]
...
% Prediction:
usePrediction = 1;
modelPath{1,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_18FEB26.mat';
modelPath{2,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_18FEB26.mat';
modelPath{3,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_18FEB26.mat';
modelPath{4,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_18FEB26.mat';
...
numConsec = 5000; % Threshold of stimClass needed to trigger stim
