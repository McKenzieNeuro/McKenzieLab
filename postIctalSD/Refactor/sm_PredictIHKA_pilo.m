...
FeatureFileOutput = 'R:\Analysis\SeizureForecasting\IHKA_rat_RF\features_pilo021826.mat';
%FeatureFileOutput = 'E:\data\IHKA\features_trans.mat';
load(FeatureFileOutput)
modelname='model_pilo_bilateral_18FEB26.mat';
...
copyfile(ops.ClassifierFileOutput, ['R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\',modelname])
%%
