...
topDirs{1} = 'R:\ASommer\PilocarpineRecordings\PTP_5.1\2-18-2026(10.42)\RHS_260218_104404';
% topDirs{1} = 'R:\DGregg\NeuralData\PTP';
fils = [];
...
FeatureFileOutput = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Features\features_pilo_20FEB26.mat';
...
for i = 1:length(fils1)
    fout  = [fileparts(fils1{i}) filesep 'auto_sz_classifier3.mat'];
   % if ~exist(fout)
        v = load(fils1{i});
