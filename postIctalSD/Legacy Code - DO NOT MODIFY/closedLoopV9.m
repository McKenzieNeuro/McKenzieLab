...
stimParam(1).config(1).subject = 'PCP 4.0'; % Subject in box 1
...
% Prediction:
usePrediction = 1;
modelPath{1,1} = 'R:\McKenzieLab\Analysis\SeizureForecasting\IHKA_rat_RF\classificationPCP.mat';
modelPath{2,1} = 'R:\McKenzieLab\Analysis\SeizureForecasting\IHKA_rat_RF\classificationPCP.mat';
modelPath{3,1} = 'R:\McKenzieLab\Analysis\SeizureForecasting\IHKA_rat_RF\classificationPCP.mat';
modelPath{4,1} = 'R:\McKenzieLab\Analysis\SeizureForecasting\IHKA_rat_RF\classificationPCP.mat';
