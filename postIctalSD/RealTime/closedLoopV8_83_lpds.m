...
% Prediction:
usePrediction = 1;
modelPath{1,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_23FEB26.mat';
modelPath{2,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_23FEB26.mat';
modelPath{3,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_23FEB26.mat';
modelPath{4,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_23FEB26.mat';
...
function [amplifierData,timeStamps,offset] = byte2doubleConv(waveformArray,numChanStream,blocksToRead,sampleFreq,downsampleFreq,useConv)
    ...
    if offset == 0    
        ...
        % Lowpass filter at half Nyquist of target frequency 
        amplifierData = lowpass(double(amplifierData),downsampleFreq/2,20000);
        % downsample to target frequency
        amplifierData = downsample(amplifierData,sampleFreq/downsampleFreq);
