...
debug_cores=[intanIO,predictModel,dataSaver,frameLabeler,DBGplotData];
...
% Prediction:
usePrediction = 1;
modelPath{1,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_27FEB26.mat';
modelPath{2,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_27FEB26.mat';
modelPath{3,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_27FEB26.mat';
modelPath{4,1} = 'R:\Analysis\McKenzieLab\postIctalSD\Refactor\Models\model_pilo_bilateral_27FEB26.mat';
...
if strcmp(copyAction,'Yes') == 1 && isnumeric(copyPathName)==0
    copyPathName = uigetdir(cd,'Select directory');
    save([copyPathName,'\config.mat'])
elseif strcmp(copyAction,'Yes') == 1 && isnumeric(copyPathName)==1
    copyAction=0;
end
                    ...
                    while 1
                        if spmdProbe(intanIO,ampData) == 1
                            ...
                            if ~isempty(saveCell)
                                ...
                                if debug(dataSaver)==1; disp('dataSaver: error in saveCell loop'); end
                                break
                            end
                        else
                            pause(0.001)
