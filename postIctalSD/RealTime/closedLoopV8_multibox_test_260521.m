...
%   260521: 
%       Attempt to add BZ filt into pipeline 
%       Method:      
%           Bypass downsampling in byte2doubleConv
%           Redirect amplifierData to BZfilt per-channel before output
...
stimParam(1).config(4).subject = 'PTP6.0'; % Subject in box 4
