...
%
%   260615
%       Change LP filter to BP filter 0.1 Hz to 450 Hz
%
%
...
stimParam(1).config(4).subject = 'PTP 6.0'; % Subject in box 4
...
% Prediction:
usePrediction = 1;
modelPath{1,1} = 'R:\ASommer\Matlab\Models\model_pilo_bilateral_08JUN26.mat';
modelPath{2,1} = 'R:\ASommer\Matlab\Models\model_pilo_bilateral_08JUN26.mat';
modelPath{3,1} = 'R:\ASommer\Matlab\Models\model_pilo_bilateral_08JUN26.mat';
modelPath{4,1} = 'R:\ASommer\Matlab\Models\model_pilo_bilateral_08JUN26.mat';
...
activeChan(1,1:2,4) = [{'d-000'},{'CA1(R)-3mm'}];
activeChan(2,1:2,4) = [{'d-001'},{'CA1(R)-2mm'}];
activeChan(3,1:2,4) = [{'d-002'},{'CA1(R)-1mm'}];
activeChan(4,1:2,4) = [{'d-003'},{'M2(R)'}];
activeChan(5,1:2,4) = [{'d-004'},{'CA1(L)-3mm'}];
activeChan(6,1:2,4) = [{'d-005'},{'CA1(L)-2mm'}];
activeChan(7,1:2,4) = [{'d-006'},{'CA1(L)-1mm'}];
activeChan(8,1:2,4) = [{'d-007'},{'M2(L)'}];
...
function [amplifierData,timeStamps,offset] = byte2doublefiltfilt(waveformArray,numChan,formatBytesPerBlock,blocksToRead,sampleFreq,downsampleFreq)
    ...
    % Inputs:
       ...
       filter1 = designfilt('lowpassiir', 'FilterOrder', 2, 'HalfPowerFrequency', 450, 'SampleRate', 20000);
