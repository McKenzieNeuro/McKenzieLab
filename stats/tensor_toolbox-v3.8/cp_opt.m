...
%   optimized is F(M) = || X - M ||^2 / || X ||^2. (The denominator
%   can be changed via the 'scale' option below.) 
%
%   [M,M0,INFO] = CP_OPT(X,R) returns the initial guess in M0 (as a 
%   ktensor) and additional information in info. 
%
...
%         o 'compact' (Limited-Memory Compact Representation (CR) solver),
...
switch(method)
    case {'lbfgsb','lbfgs','fminunc','fmincon','compact'}
