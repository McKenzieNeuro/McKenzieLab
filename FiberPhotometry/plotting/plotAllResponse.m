...
%% NE2h2 
dirs = [...
     {[masterDir 'DonaldsonT\Antagonist-220419-141747\NE2h2\NE2h2-220419-143209']}; ...
    ]
...
dirs = [...
    ...
    {[masterDir 'DonaldsonT\DA_animals_NEE-210817-124922\NE2h9\NE2h9-220207-141915']} ; ...
    {[masterDir 'DonaldsonT\DA_animals_NEE-210817-124922\NE2h9\NE2h9-220404-132013']} ; ...
    {[masterDir 'DonaldsonT\DA_animals_NEE-210817-124922\NE2h9\NE2h9-220405-140432']} ; ...
    {[masterDir 'DonaldsonT\DA_animals_NEE-210817-124922\NE2h9\NE2h9-220406-122404']} ; ...
    {[masterDir 'DonaldsonT\DA_animals_NEE-210817-124922\NE2h9\NE2h9-220407-105425']} ; ...
...
for i = 1:length(dirs)
    ...
    if exist('newContext.mat')
        [signal_DFoF,ts_data,ev_tims,ix,ts_PETH] = sm_PETH_DFoF(pwd,'newContext.mat',{'newContext','homeCage','newContext_drug'},'photoBleachCorrection','exp2','plotIntervals',[300 300],'returnedDataType','corrected');
        ...
        newConDrug(i,:) =  nan(1,size(ts_PETH,2));
