function feat = sm_GetDataFeature_rat_wtnormsk(data,tim,ops)
...
if ~stim_art
    ...
    feat(1:2:40)=feat(1:2:40)/mean(feat(1:2:26));
    feat(2:2:40)=feat(2:2:40)/mean(feat(2:2:26));
else
    %error('here')
end
end