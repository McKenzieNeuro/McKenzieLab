function sm_getPowerPerChannel_Gross(ch,chanNum,channelName,varargin)
...
featureList = ['ch:' channelName ' ' featureList];
...
fnameOut_merged = [dirOut filesep basename '_' chanNum '.dat'];

%save merged file with all features and with time series
sm_MergeDats(fils,fnameOut_merged)

fnameOutfeature = [dirOut filesep basename '_' chanNum '.mat'];
