        ...
        if any(presses)
            ...
            switch choice
                case 'Yes'
                    ...
                    [FileName,dname] = uiputfile('*.xls','I hope the mice fell well');
                    ...
                    if ischar(FileName)
                        ...
                        if mod(size(presses,1),2)==0 && all(presses(1:2:end,2) - presses(2:2:end,2) ==0)
                           ...
                           % presses(:,1) = presses(:,1)/vid.FrameRate;
                            ...
                            choice1 = menu( 'Non-paired', ...
                                'Return to video coding','Save anyways','Quit without saving');
                            switch choice1
                                case 1
                                    return;
                                case 2
