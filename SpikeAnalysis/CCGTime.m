...
[ccg1,cnt] = (CCGHeartTime(times,uint32(groups),binSize,uint32(halfBins),win,win_inc));
% -----------------------------------
% 
% Reshape the results
ccg1 = double(ccg1);
...
ccg1 = reshape(ccg1,[nBins n n nWin]);


if n < nGroups,
	ccg1(nBins,nGroups,nGroups) = 0;
end
