function ops = KilosortConfiguration_McKenzie(XMLfile)
...
ops.fproc = 'R:\McKenzieLab\IMAdams\Kilosort configuration\temp.dat';% PUT YOUR PATH + FILE NAME WITH ~100GB FREE (SSD IS BEST)
...
ops.Th               = [6 12 12];    % threshold for detecting spikes on template-filtered data ([6 12 12]) Mckenzie used [6 10 10]
ops.lam              = [15 50 50];
