function [rez, DATA, uproj] = sm_preprocessData(ops)
tic;
uproj = [];
...
while 1
    ...
    if strcmp(ops.whitening,'full_median')
        
        
                ok = median(dataRAW,2);
                
                dataRAW = dataRAW - repmat(ok,1,size(dataRAW,2));
