function savepath = sm_KiloSortWrapper3(varargin)
...
if isempty(config_version)
    ...
    ops = KilosortConfiguration3(XMLFilePath);
else
    disp('Running Kilosort with user specific settings')
    config_string = str2func(['KilosortConfiguration3_' config_version]);
...
rez = memorizeW(rez, rez.W, rez.dWU,rez.U,rez.mu);
