    ...
    def attach_to_controller(self, controller):
        ...
        def on_gui_ready(sender, gui):
            ...
            def VisualizeShortISI():
                """Split all spikes with an interspike interval of less than 2ms into a separate
                ...
                logger.info('Detecting spikes with ISI less than 0.5 ms')
